...
CATALOGO_MAP = {
    '50001559': '1215504785832997',  # FERROVIAL — detectar desde Excel
    '50001558': '1215504785832997',
    '50001554': '1215118022011721',
    '50001553': {  # múltiples GIDs
        'OT4326': '1214969047721199',
        'OT4327': '1214969047720950',
        'OT4323': '1214969284200793',
    },
...
def leer_excel(path):
    ...
    col = {
        ...
        'av': headers.get('Avance Tarea', 19),
...
def extraer_gid_de_nombre(filename, proyecto_nombre):
    ...
    if pedido in CATALOGO_MAP:
        ...
        if isinstance(val, str):
            return pedido, val
        # dict con variantes — tomar la primera
