...
<div class="tabcontent" id="tab-cascada">
  <div class="filtros">
    ...
    <select id="fCascadaSeccion" onchange="renderCascada()">
      <option value="">Etapa: Todas</option>
      <option value="kick_off">Kick off</option>
      <option value="ingenieria">Ingeniería</option>
      <option value="propuesta">Propuesta compras</option>
      <option value="compras">Compras</option>
      <option value="ingenieria_diseno">Ingeniería y diseño</option>
      <option value="bodega">Bodega</option>
      <option value="montaje">Montaje</option>
      <option value="logistica">Logística</option>
      <option value="cierre">Cierre proyecto</option>
    </select>
  </div>
...
function renderCascada() {
  ...
  const filtroSeccion = document.getElementById('fCascadaSeccion') ? document.getElementById('fCascadaSeccion').value : '';
  ...
  if (filtroSeccion) filtradas = filtradas.map(c => c.filter(t => getSeccion(t.name) === filtroSeccion)).filter(c => c.length > 0);
